...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../View/css/style_account.css"/>
    </head>
    <body>
        <section class="a_top">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 a_top_img">
                        <img src="../Others/images/login_logo.png" alt="">
                    </div>
                    ...
                    <div class="col-9 st_content">
                        <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 eva">
                                                        <form action="" method="GET">
                                                            ...
                                                            if ($eva_value == 0) {
                                                                echo " <a href = '../Controller/Euvalation.php?ID=" . $cou_val . "' > Evaluation</a>";
                                                            } else {
                                                                echo " <a href = '../Controller/Euvalation.php?ID=" . $cou_val . "' class = 'disabled'>Evaluation</a>";
                                                            }
                                                            ?>
                                                        </form>
                                                    </div>
                            ...
                            <div class = "tab-pane fade text-center a_log_out" id = "v-pills-settings" role = "tabpanel" aria-labelledby = "v-pills-settings-tab">
                                ...
                                <a href = "../Controller/login_html.php?logout = '1'">yes</a>
                            </div>
                        </div>
                    </div>
                </div>
