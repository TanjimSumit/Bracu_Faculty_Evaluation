    ...
    <body>
                    ...
                    <div class="col-9 admin_content">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-settings2" role="tabpane2" aria-labelledby="v-pills-settings-tab2">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" action="../Model/start_addcourse.php">
                                    ...
                                    <div class="col-md-12">
                                        <form method="POST" action="../Model/start_evaluation.php">
                                            <div class="admin_f_ques">
        ...
        <script>
            function course_value(val) {
                $.ajax({
                    type: "POST",
                    url: "../Model/cou_info_value_get.php",
            ...
            function student_value(val) {
                $.ajax({
                    type: "POST",
                    url: "../Model/st_info_value_get.php",
            ...
            function faculty_value(val) {
                $.ajax({
                    type: "POST",
                    url: "../Model/faculty_info_value_get.php",
